...
- **บัญชีผู้ดูแลระบบ**: คลัง ID/รหัสผ่านแสดงพนักงานทุกบัญชีรวมถึงบัญชี Admin และบัญชีของผู้ที่กำลังเปิดดูเอง แถวของตนเองมีป้าย "บัญชีของคุณ" และลิงก์ไปแก้ไขได้
